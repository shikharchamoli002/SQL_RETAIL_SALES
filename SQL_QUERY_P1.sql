...
--DATA ANALYSIS/,BUSINES KEY PROBLEMS/ANSWERS
...
-- Q.6 Write a SQL query to find the total number of transactions (transactions_id)
...
---CTE = COMMON TABLE EXPLAINATIONS
WITH hourly_sale AS
(
    SELECT *,
           CASE
